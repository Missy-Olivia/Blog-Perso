...
class CommentTest(unittest.TestCase):
        ...
        def setUp(self):
                self.user_New = User(username = 'Missy',password = 'yeet', email = 'missy@mail.com')
                self.new_comment = Comment(blog_id=12345,comment='love me some blog', user = self.user_New )
